/**
 * Client-side mirrors of the limits the API enforces
 * (`backend/src/common/limits.ts`). They exist so a field can stop you at the
 * boundary instead of letting you write 300 characters and then rejecting
 * them; the server remains the authority.
 */
